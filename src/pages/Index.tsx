        ...
        <Card className="shadow-xl border-0 dark:bg-gray-800">
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {!isSignUp && !isForgotPassword && (
                <div className="text-right">
                  <button
                    ...
                    className="text-sm text-blue-indigo hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors"
                  >
                    Forgot password?
                  </button>
                </div>
              ...
              >
                {isAuthLoading ? "Processing..." : (isForgotPassword ? "SEND RESET LINK" : (isSignUp ? "SIGN UP" : "SIGN IN"))}
              </Button>
            </form>
            ...
            <div className="mt-6 text-center space-y-2">
              {isForgotPassword ? (
                <button
                  ...
                  className="text-blue-indigo hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors"
                  disabled={isAuthLoading}
                >
                  Back to sign in
                </button>
